...
class SupervisorEmployeesScreen extends StatefulWidget {
  const SupervisorEmployeesScreen({super.key});

  @override
  State<SupervisorEmployeesScreen> createState() => _SupervisorEmployeesScreenState();
}

class _SupervisorEmployeesScreenState extends State<SupervisorEmployeesScreen> {
  final SupervisorHomeController controller = Get.find<SupervisorHomeController>();

  @override
  void initState() {
    super.initState();
    // Call fetchEmployeesUnderSupervisor after the first frame is built
