...
const kPrimaryColor =  Color(0xFF004282);

const kPrimaryColorLight =  Color(0xFF0B59A7);

const kSecondaryColor = Color(0xffD3A907);
const kOverlay = Color(0xFF141414);

//! All Text Colors
const kSubText = Color(0xFF686868);
...
const kGreyText = Color(0xff767676);
...
const kgreenColor = Color.fromARGB(255, 62, 224, 59);
...
const kbackgroundContainer = Color(0xFFF1F1F1);
...
const kBorderColor2 = Color(0xFFEFEFEF);
...
const kTexfeildGradeintColor = LinearGradient(
  colors: [Color(0xFF6A5ACD), Color(0xFF4169E1)],
  begin: Alignment.topCenter,
  end: Alignment.bottomCenter,
);

const kTexfeildGradeintColor2 = LinearGradient(
  begin: Alignment(1, 1.81),
  end: Alignment(-0.53, -0.72),
  colors: [Color(0xFF6431FA), Color(0xFFDEA0E3)],
);

const kContainerBackgroundGradeintColor = LinearGradient(
  colors: [
    Color(0xFFB16CEA), // violet
    Color(0xFF6F3BD7), // deep purple
  ],
  begin: Alignment.centerLeft,
  end: Alignment.centerRight,
);

const kChatBackgroundGradeintColor = LinearGradient(
  colors: [
    Color(0xFF6F3BD7), // deep purple
    Color(0xFFB16CEA), // violet
  ],
